...
function buildScript(answers: Answers): Record<StepId, StepDef> {
  ...
  return {
    ...
    ps_empresa: {
      ...
      card: {
        title: '🚌 Consorcio Express S.A.S. (CEX)',
        subtitle: 'Operador del SITP en Bogotá — Concesión TMSA',
        body: [
          '🎯 Misión: movilidad eficiente, confiable y segura para los usuarios del transporte público masivo de Bogotá',
          '🌱 Visión 2028: más de la mitad de la flota con tecnologías limpias y líderes nacionales en el sector',
          '🗺️ Operamos rutas Troncales, Urbanas, Alimentadoras, Complementarias y Especiales en 13 zonas de la ciudad',
          '🤝 Cultura organizacional basada en valores y equipo humano de alto desempeño',
        ],
      },
...
export default function WaApplyFlow() {
  ...
  // Deliver bot messages for initial step on mount — guard prevents StrictMode double-fire
  useEffect(() => {
